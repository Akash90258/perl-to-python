...
Config_File = glob.glob("/home/ubuntu/perl-to-python/CONFIG_PYTHON_UNIX.xlsx")
...
def Send_Email_SMTP(Attachment_Path,Attachment_Name,opco,df_Config):
    print("============== Attachment =======================")
    print(Attachment_Path+Attachment_Name)
    # subject = 'New MTN Backup Tracker for '+ GetOpco_Name(opco)
    # text = 'New MTN Backup Tracker for '+ GetOpco_Name(opco)
    # fromaddr = 'akashagrawal20897@gmail.com'#'no-reply@AutoBOT' 
    # toaddr = ['akashagrawal90258@gmail.com']
    # COMMASPACE = ', '
    ...
    #    # smtpObj.starttls()
    #    smtpObj.login('akashagrawal20897@gmail.com', "Akashagrawal@1") 
